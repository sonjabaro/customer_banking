...
def main():
    ...
    """
    savings_account_balance =float(input('Enter your starting balance: '))
    savings_account_interest =float(input("Enter your interest rate:"))
    savings_account_months = int(input("How many months is your term?: "))
    ...
    CD_account_balance =float(input('Enter your starting balance: '))
